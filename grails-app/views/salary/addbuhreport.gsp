<html>
  <head>
    <title>Prisma: Зарплата - Новая бух. ведомость</title>
  ...
  <body>
    <h3 class="fleft">Новая бух. ведомость</h3>
    ...
    <div class="clear"></div>
    <g:form name="newcashreportForm" url="${[action:'incertbuhreport']}" method="post" enctype="multipart/form-data" target="upload_target">
