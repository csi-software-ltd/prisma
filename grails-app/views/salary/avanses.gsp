    ...
    <table class="list" width="100%" cellpadding="0" cellspacing="0" border="0">
      ...
      <g:each in="${searchresult.records}" status="i" var="record">
        <tr align="center">
          ...
          <g:elseif test="${record.is_confirm==-1}"><abbr title="Отказано"><i class="icon-ban-circle"></i></abbr></g:elseif>
          ...
          <td>
            <a class="button" href="${g.createLink(controller:controllerName,action:'avans',id:record.id)}" title="Редактировать"><i class="icon-pencil"></i></a>
          <g:if test="${!record.modstatus&&iscandelete}">
            &nbsp;&nbsp;<a class="button nopad" style="z-index:1" title="Удалить" onclick="deleteAvans(${record.id})"><i class="icon-trash"></i></a>
          </g:if>
          </td>
        </tr>
      </g:each>
