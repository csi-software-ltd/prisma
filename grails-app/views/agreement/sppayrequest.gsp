...
<input type="text" class="auto" id="payrequest_summa" name="summa" value="${number(value:payrequest?.summa?:agr.actrate)}"/>
...
<label class="auto" for="payrequest_is_dop">
  <input type="checkbox" id="payrequest_is_dop" name="is_dop" value="1" <g:if test="${payrequest?.is_dop}">checked</g:if> />
  Оплата доп.услуг
</label>
