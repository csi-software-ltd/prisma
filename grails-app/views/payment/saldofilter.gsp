<g:formRemote name="paymentForm" url="[controller:'payment',action:'saldolist']" update="list" onSuccess="scrollToAnchor()">
  ...
  <g:select class="mini" name="order" value="${inrequest?.order?:0}" from="['по банку','по компании','по дате факт. остатка']" keys="031"/>
  ...
  <div class="fright">
    <input type="reset" class="spacing" value="Сброс" onclick="resetSaldoFilter()"/>
    <input type="button" id="form_submit_button_logic" value="Показать" onclick="submitLogic()"/>
