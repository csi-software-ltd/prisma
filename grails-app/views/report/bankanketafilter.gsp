<g:form name="allForm" url="[controller:controllerName,action:'bankanketa']" target="_blank">
  <label class="auto" for="id">Компания:</label>
  <g:select name="id" from="${companies}" optionKey="company_id" optionValue="cname" onchange="getBankList(this.value,2)"/>
